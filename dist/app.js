...
function home() {
  return `<section class="portrait-cover" aria-label="Entrada a la obra de ENRIQUE SEGARRA I GARIBO"><img src="assets/retrato-portada-horizontal-v1.png" alt="ENRIQUE SEGARRA I GARIBO sostiene una escultura de madera" loading="eager" decoding="async"><div class="portrait-cover-copy"><h1>ENRIQUE<br>SEGARRA<br>I GARIBO</h1><p>Arte, materia y memoria en movimiento.</p><a class="portrait-cover-link" href="#/obra">Entrar en la obra <span aria-hidden="true">↗</span></a></div></section>`;
}
